...
first_deployment <- read_csv("06092023_Avg_Current.csv")
second_deployment <- read_csv("07272023_Avg_Current.csv")
third_deployment <- read_csv("08292023_Avg_Current.csv")
```
...
```{r}
first_temp <- read_csv("06092023_Temp.csv")
second_temp <- read_csv("07272023_Temp.csv")
third_temp <- read_csv("08292023_Temp.csv")
```
